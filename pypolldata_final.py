...
f"Charles Casper Stockham:{Charlesvotes_percentsge,Charlesvotes}\n"
f"Diana DeGette{Dianavotes_percentage,Dianavotes}\n"
f"Raymon Anthony Doane{Raymonvotes_percentage,Raymonvotes}\n"
f"Winner :{Greatest_increase_in_Candidate}" 
